...
public class GetTCPPrinterInfoTask extends ExecutorTask<Void, Boolean, Map<String,String>> {
    ...
    public GetTCPPrinterInfoTask(DiscoveredPrinter selectedPrinter, SelectedPrinterTaskCallbacks aCallback, Context aContext) {
