...
public class MultiCastPrinterDiscovery {

    private static final String TAG = "MulticastDiscovery";
    private Context context;
    private PrinterDiscoveryCallback callback = null;
    private int multicastHops = 5;
    private List<DiscoveredPrinter> discoveredPrinters = null;

    public MultiCastPrinterDiscovery(Context aContext, int aMulticastHops, PrinterDiscoveryCallback aCallback)
    {
        context = aContext;
        callback = aCallback;
        multicastHops = aMulticastHops;
    }

    public void startDiscovery()
    {
        discoveredPrinters = new ArrayList<>();
        // Init Multicast Discovery
        try {
